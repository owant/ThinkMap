...
//        tree.addNode(nodeT, nodeY, nodeZ);
        NodeModel<String> myPlan = new NodeModel<>(mView.getDefualtPlanString());
        this.mTreeModel = new TreeModel<>(myPlan);
    ...
    @Override
    public void changeNode(NodeModel<String> node) {
        mView.showEditNote(node);
    }
